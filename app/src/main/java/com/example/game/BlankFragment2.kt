...
class BlankFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        resim = rootView.findViewById(R.id.imageView2_1)
        resim2 = rootView.findViewById(R.id.imageView2_2)
        resim3 = rootView.findViewById(R.id.imageView2_3)
        soru = rootView.findViewById(R.id.textView2)
        sayac = rootView.findViewById(R.id.textView_sayac2)
