...
class BlankFragment4 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_blank4, container, false)
        resim = rootView.findViewById(R.id.imageView4_1)
        resim2 = rootView.findViewById(R.id.imageView4_2)
        resim3 = rootView.findViewById(R.id.imageView4_3)
        resim4 = rootView.findViewById(R.id.imageView4_4)
        resim5 = rootView.findViewById(R.id.imageView4_5)
        resim6 = rootView.findViewById(R.id.imageView4_6)
        sayac = rootView.findViewById(R.id.textView_sayac4)

        soru = rootView.findViewById(R.id.textView4)
